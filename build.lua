...
tagfiles = {"tikzmarmots.sty", "*-doc.tex", "README.md", "CHANGELOG.md"}
...
uploadconfig = {
  ...
  license      = "lppl1.3c",
  summary      = "A small LaTeX package to draw marmots with TikZ",
...
-- cleanup ===========================================================
cleanfiles = {"tikzmarmots-ctan.curlopt", "tikzmarmots-ctan.zip"}
